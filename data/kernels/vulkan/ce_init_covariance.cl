// Vulkan port of colorequal.cl :: init_covariance.
// covariance = outer product of UV with itself (xx, xy, xy, yy).
// 2 bindings (covariance float4, uv float2), 8 B PC.
#include "dt_vulkan_common.h"

kernel void ce_init_covariance(global float4 *covariance,
