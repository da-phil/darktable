...
FEATURES="AI CAMERA COLORD GMIC GRAPHICSMAGICK IMAGEMAGICK JXL KWALLET LIBSECRET LUA MAC_INTEGRATION MAP MCP OPENCL OPENCV OPENEXR OPENMP UNITY VULKAN VULKAN_POC WEBP"
